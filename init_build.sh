...
function install_dependencies(){
	...
	apt install -y $EXTRA_PKG ack antlr3 asciidoc autoconf automake autopoint binutils bison build-essential \
		...
		libz-dev lrzsz mkisofs msmtp nano ninja-build p7zip p7zip-full patch pkgconf python3 python3-pip python3-ply \
		python-docutils qemu-utils quilt re2c rsync scons squashfs-tools subversion swig texinfo uglifyjs unzip \
